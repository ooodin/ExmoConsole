...
open class Chart: UIControl {
    ...
    */
    ...
    fileprivate var layerStore: Array<CALayer> = []
    ...
    Adds a chart series.
    */
    open func addSeries(_ series: ChartSeries) {
    ...
    */
    open func addSeries(_ series: Array<ChartSeries>) {
        for s in series {
            addSeries(s)
        }
    }
    ...
    */
    open func removeSeriesAtIndex(_ index: Int) {
    ...
    */
    ...
    fileprivate func drawLine(xValues: Array<Float>, yValues: Array<Float>, seriesIndex: Int) {
    ...
    fileprivate func drawArea(xValues: Array<Float>, yValues: Array<Float>, seriesIndex: Int) {
        let isAboveXAxis = isVerticalSegmentAboveXAxis(yValues)
        ...
        if isAboveXAxis {
            colors.append(series[seriesIndex].colors.above.withAlphaComponent(areaAlphaComponent).cgColor)
        } else {
            colors.append(series[seriesIndex].colors.below.withAlphaComponent(areaAlphaComponent).cgColor)
        }
        ...
        layerStore.append(gradientLayer)
    }
    ...
    fileprivate func drawAxes() {
        ...
        context?.move(to: CGPoint(x: drawingWidth, y: 0))
        context?.addLine(to: CGPoint(x: drawingWidth, y: drawingHeight + topInset))
        context?.strokePath()
...
//            CGPathAddLineToPoint(path, nil, left, drawingHeight  + topInset)
            ...
            path.move(to: CGPoint(x: left, y: drawingHeight  + topInset))
